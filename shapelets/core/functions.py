...
def cartesian1D(
    ...
    """ Returns a 1D cartesian shapelet function evaluated at (x1) [float or array].
...
def cartesian2D(
    ...
    """ Returns a 2D cartesian shapelet function evaluated at (x1,x2) [float or array].
    ...
    ----------
    n1 : int
        Shapelet order in x direction. Acceptable values are :math:`n1 \geq 0`
    n2 : int
        Shapelet order in y direction. Acceptable values are :math:`n2 \geq 0`
    x1 : Union[float,np.ndarray]
...
def polar2D(
    ...
    """ Returns a 2D polar shapelet function evaluated at (x1,x2) [float or array].
    ...
    n : int
        Shapelet order. Acceptable values are :math:`n \geq 0`
    m : int
        Shapelet order. Acceptable values :math:`m \in [-n, n]`. However, if n is odd/even, m must also be odd/even respectively
    x1 : Union[float,np.ndarray]
        First input to shapelet function
    x2 : Union[float,np.ndarray]
        Second input to shapelet function
...
def orthonormalpolar2D_n0(
    ...
    """ Returns a 2D orthonormal polar shapelet function evaluated at (x1,x2) [float or array].
    ...
    ----------
    m : int
        Shapelet degree of rotational symmetry. Acceptable values are :math:`m > 1`
    x1 : Union[float,np.ndarray]
        First input to shapelet function
    x2 : Union[float,np.ndarray]
        Second input to shapelet function
...
def exponential1D(
    ...
    """ Returns a 1D exponential shapelet function evaluated at (x1) [float or array].
    ...
    ----------
    n : int
        Shapelet order. Must be non-negative. Acceptable values are :math:`n \geq 1`
    x1 : Union[float,np.ndarray]
        The input to the shapelet function. Acceptable values are :math:`x1 \geq 0`
    beta : float
        The shapelet length scale parameter
...
def exponential2D(
    ...
    """ Returns a 2D exponential shapelet function evaluated at (x1,x2) [float or array].
    ...
    ----------
    n : int
        Shapelet order. Must be non-negative. Acceptable values are :math:`n \geq 0`
    m : int
        Shapelet order. Acceptable values are :math:`m \in [-n, n]`
    x1 : Union[float,np.ndarray]
        First input to shapelet function
    x2 : Union[float,np.ndarray]
        Second input to shapelet function
